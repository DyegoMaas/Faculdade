...
public class Estado8Puzzle implements Estado, Heuristica, Antecessor {
     ...
     */
    public int h() {
    	//return h1(); //14610 nodos visitados em 637 mili-seg.
    	//return h2(); //1771 nodos visitados em 355 mili-seg.
    	//return h3(); //20358 nodos visitados em 715 mili-seg.
    	//return h1() + h2(); //522 nodos visitados em 155 mili-seg.
        return h2() + h3(); //347 nodos visitados em 118 mili-seg.
    	//return h1() + h3(); //3031 nodos visitados em 383 mili-seg.
    	//return h1() + h2() + h3(); //153 nodos visitados em 58 mili-seg.
